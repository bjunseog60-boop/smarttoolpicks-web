#!/usr/bin/env python3
"""
SmartToolPicks Auto Content Agent
Generates new software/SaaS guides using Gemini API for text and Imagen 4.0 Ultra for images.
"""
...
def generate_guide_json(client, existing_slugs: list[str]) -> dict:
    prompt = f"""You are an elite B2B SaaS and tech gear content strategist for SmartToolPicks. Your goal is to drive organic traffic and maximize affiliate conversions.
...
{{
  ...
  "tag": "Guide",
  "emoji": "💻",
  "hero_image_prompt": "A detailed, photorealistic prompt for an AI image generator (Imagen 4) for the main cover image. Feature a high-end tech workspace or SaaS dashboard concept. End the prompt with 'Typography text overlay reading SmartToolPicks'.",
  "affiliateProducts": [
    {{
      "name": "Specific Tech Product or Software Name",
      "brand": "Brand Name",
      "price": "$XX",
      "url_index": 0,
      "tag": "Best Overall",
...
Pick a fresh, highly-searchable tech topic. Ideas:
Best AI writing assistants 2026, Top mechanical keyboards for coding, Best CRM software for small business, Ultimate WFH desk setup."""
...
def main():
    print("🤖 SmartToolPicks Content Agent (Premium Edition) starting...")
